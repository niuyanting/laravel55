        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="{{route('admin.user.doEdit')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="file" placeholder="用户头像" class="form-control" name="image_url"/><img src="{{$user->image_url}}" style="width:30px;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="radio"><label><input type="radio" checked="" name="is_super" value="2" @if($user->is_super == 2) checked @endif>是</label></div>
                    </div>
                </div>
