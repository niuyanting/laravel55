        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="{{route('admin.user.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="radio"><label><input type="radio" name="is_super" value="1">否</label></div>
                        <div class="radio"><label><input type="radio" checked="" name="is_super" value="2">是</label></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="radio"><label><input type="radio" name="status" value="1">正常</label></div>
                        <div class="radio"><label><input type="radio" checked="" name="status" value="2">禁用</label></div>
                    </div>
                </div>
